...
- Continuing my studies at New York University for a Master of Science in Computer Science.
- Developing APCompTutor.AI, an app to help students with AP computer science exam preparation.

🤝 I’m looking to collaborate on:
- Projects related to AI applications, Education and web development that create positive impacts.

🌱 I’m currently learning:
- Advanced AI concepts and their practical applications.

⚡ Fun fact:
- Before diving into tech, I was one of the most decorated soccer players in New York, which honed my discipline and teamwork skills that I now apply to coding and leading projects.
  
## 💫 Work:

🧑🏻‍💼 I worked as a Software Engineer Intern at Roadcall.co, a startup focused on management systems for trucking companies. I co-designed and developed key features like the admin note and implemented similar note features in other parts of the application. Additionally, I worked on pagination and badge counts to display active loads on specific tabs and contributed to code reviews to ensure quality.

📊 I worked as a Software Engineer Intern at Treehouse Strategy, a management consulting firm focused on helping language service providers and localization companies improve operational efficiency. I developed a dynamic dashboard that enhanced data visibility and access for clients. I also optimized internal tools and created reusable components to streamline operations.

👨🏻‍🏫 I worked as a Computer Science Tutor at Varsity Tutors and St. Thomas Aquinas College, tutoring students in Java, Data Structures, and Object Oriented Programming. My communication skills and patience were often highlighted by students and parents.

## 💫 Favorite Projects:
🚀 NYU Interview Prep:
- I led a team of 5 to build a career web app using Python, Django, and React, designed to connect students pursuing similar career paths. The platform allowed users to post videos of 
  themselves taking mock interviews and receive feedback from other users, with AWS S3 integration for secure media storage.

🧼 Cleaning Service App:
- I developed a Cleaning Service App as a freelancer, building a booking system using React, GraphQL, and Express.js. The app included scheduling, confirmations, and payment processing, with 
  AWS S3 used for secure media storage.

🎧 FatEar:
- I developed a dynamic music streaming app called FatEar, using React for the frontend and Flask with MySQL for the backend. I implemented user authentication, playlist management, and song search, with RESTful APIs and external API integration for notifications.
